...
import { mockBloodBank, mockBloodStock, mockIncomingRequests } from '../../data/bloodBankMockData';
...
const initials = mockBloodBank.admin_name.split(' ').slice(0, 2).map(n => n[0]).join('');
            ...
            <div style={{ position: 'fixed', top: 0, left: 240, right: 0, height: 64, background: 'rgba(7,7,11,0.92)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 32px', zIndex: 30 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer' }}>
                        ...
                        <span style={{ fontFamily: 'var(--font-sub)', fontWeight: 600, fontSize: 14, color: '#fff' }}>{mockBloodBank.admin_name.split(' ')[1]}</span>
